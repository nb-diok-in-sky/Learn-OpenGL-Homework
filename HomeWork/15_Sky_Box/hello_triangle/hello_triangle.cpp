...
int main()
{
    ...
    Shader ourShader("D:/LearnOpenGL/HomeWork/15_Sky_Box/hello_triangle/vertex.glsl",
        "D:/LearnOpenGL/HomeWork/15_Sky_Box/hello_triangle/fragment.glsl");

    Shader lightingShader("D:/LearnOpenGL/HomeWork/15_Sky_Box/hello_triangle/light_object_vert.glsl",
        "D:/LearnOpenGL/HomeWork/15_Sky_Box/hello_triangle/light_object_frag.glsl");


    Shader normalShader("D:/LearnOpenGL/HomeWork/15_Sky_Box/hello_triangle/shaderSingleColor_vertex.glsl",
        "D:/LearnOpenGL/HomeWork/15_Sky_Box/hello_triangle/shaderSingleColor.glsl");

    Shader skyboxShader("D:/LearnOpenGL/HomeWork/15_Sky_Box/hello_triangle/skybox_vert.glsl",
        "D:/LearnOpenGL/HomeWork/15_Sky_Box/hello_triangle/skybox_frag.glsl");
    ...
    {
        "D:/LearnOpenGL/static/texture/skybox/right.jpg",
        "D:/LearnOpenGL/static/texture/skybox/left.jpg",
        "D:/LearnOpenGL/static/texture/skybox/top.jpg",
        "D:/LearnOpenGL/static/texture/skybox/bottom.jpg",
        "D:/LearnOpenGL/static/texture/skybox/front.jpg",
        "D:/LearnOpenGL/static/texture/skybox/back.jpg"
    };
    ...
    glStencilFunc(GL_ALWAYS, 1, 0xFF);
     ...
     while (!glfwWindowShouldClose(window))
     {
         ...
         ourShader.use();   
         //这里是手电筒
         ourShader.setVec3("flashlight.position", cameraPos);
         ourShader.setVec3("flashlight.direction", cameraFront);
         ourShader.setFloat("flashlight.cutOff", glm::cos(glm::radians(12.5f)));
         ourShader.setFloat("flashlight.outerCutOff", 0.953f);
         ...
         //这里是diright
         ourShader.setVec3("dirLight.ambient", 1.0f, 0.5f, 0.31f);
         ourShader.setVec3("dirLight.diffuse", 1.0f, 0.5f, 0.31f);
         ourShader.setInt("dirLight.specular", 1);
...
*/
         ourShader.setVec3("flashlight.ambient", 0.2f, 0.2f, 0.2f);
         ourShader.setVec3("flashlight.diffuse", 0.5f, 0.5f, 0.5f);
