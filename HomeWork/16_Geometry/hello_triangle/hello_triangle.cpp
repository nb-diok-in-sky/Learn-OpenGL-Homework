...
int main()
{
    ...
    Shader ourShader("D:/LearnOpenGL/HomeWork/16_Geometry/hello_triangle/vertex.glsl",
        "D:/LearnOpenGL/HomeWork/16_Geometry/hello_triangle/fragment.glsl","D:/LearnOpenGL/HomeWork/16_Geometry/hello_triangle/Geometry.glsl");
   ...
   //创建VBO对象用于存储大量的顶点，称作顶点缓冲对象
    ...
    stbi_set_flip_vertically_on_load(true);
     ...
     while (!glfwWindowShouldClose(window))
     {
         ...
         int texIndex = 0;
         ourShader.setFloat("time", xOffset);
