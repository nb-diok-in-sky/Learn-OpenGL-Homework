...
int main()
{
    ...
    Shader ourShader("D:/LearnOpenGL/HomeWork/11_Light_flashlight/hello_triangle/vertex.glsl",
        "D:/LearnOpenGL/HomeWork/11_Light_flashlight/hello_triangle/fragment.glsl");

    Shader lightingShader("D:/LearnOpenGL/HomeWork/11_Light_flashlight/hello_triangle/light_object_vert.glsl",
        "D:/LearnOpenGL/HomeWork/11_Light_flashlight/hello_triangle/light_object_frag.glsl");
    ...
    stbi_image_free(data2);
     ...
     while (!glfwWindowShouldClose(window))
     {
         ...
         ourShader.setFloat("light.outerCutOff", 0.953f);
